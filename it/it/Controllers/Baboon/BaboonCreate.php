...
class BaboonCreate extends Controller {
	 ...
	 * Method indexMethod
	 *
	 * @param $r $r [explicite description]
	 *
	 * @return void
	 */
	...
	public static function storeMethod($r) {
		...
		' . "\n";
		$store .=
		$file. ' = it()->getFile("{Name}", ${Name}->id)->full_path;'."\n".
		'{ModelName}::find(${Name}->id)->update($data);'."\n";
		}
	...
	public static function number($data) {
		return view('baboon.elements.create.number', ['data' => $data]);
	}
